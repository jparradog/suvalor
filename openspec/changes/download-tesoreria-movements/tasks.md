...
- [x] 3.2 Only after 3.1, modify `suvalor/pagina.py`/`suvalor/descargador.py` to navigate Tesoreria, fill dates, optionally select account without echoing labels, and export PDF/XLS.
